...
public class CoorTransform {
    ...
    public void print(){
        Log.e(TAG,acc_phone_x+" "+acc_phone_y+" "+acc_phone_z+" "+orien_x+" "+orien_y+" "+orien_z+" "+acc_global_x+" "+acc_global_y+" "+acc_global_z);
    }
    ...
    public void transform(){
        ...
        matrixAccPhone.print();
       // Log.e(TAG, " inner");
        //matrixInner.print();
        matrixAccGlobal = Matrix.multiply(matrixInner,matrixAccPhone);
        Log.e(TAG," global");
        matrixAccGlobal.print();
    }

    public void transformInSimple(){
    ...
    private void createMatrix(){
        ...
        float m11 = (float) (Math.cos(orien_z) * Math.cos(orien_y) - Math.sin(orien_z) * Math.sin(orien_x) * Math.sin(orien_y));
        float m12 = (float) (Math.sin(orien_z) * Math.cos(orien_y) + Math.cos(orien_z) * Math.sin(orien_x) * Math.sin(orien_z));
        ...
        float m31 = (float) (Math.cos(orien_z) * Math.sin(orien_y) + Math.sin(orien_z) * Math.sin(orien_x) * Math.cos(orien_y));
        float m32 = (float) (Math.sin(orien_z) * Math.sin(orien_y) - Math.cos(orien_z) * Math.sin(orien_x) * Math.cos(orien_y));
    ...
    public float getOrien_x() {
        return orien_x;
    }

    public void setOrien_x(float orien_x) {
        this.orien_x = orien_x;
    }

    public float getOrien_y() {
        return orien_y;
    }

    public void setOrien_y(float orien_y) {
        this.orien_y = orien_y;
    }

    public float getOrien_z() {
        return orien_z;
    }

    public void setOrien_z(float orien_z) {
        this.orien_z = orien_z;
    }
}
